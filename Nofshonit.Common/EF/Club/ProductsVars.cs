...
{
    public partial class ProductsVars
    {
        ...
        public bool? ManualSubsidy { get; set; }
        public bool? ManualLimits { get; set; }
        public int? NumOfTreats { get; set; }
        public string Slink { get; set; }
        public int? SupplierPayer { get; set; }
        public int? LogicType { get; set; }
        public int? SerieId { get; set; }
        public int? WalletId { get; set; }
        public int? IssuerId { get; set; }
        public int? ClubBillingMode { get; set; }
        public bool? IsClubBillingModeOverride { get; set; }
        public bool? IsSendToFriend { get; set; }
        public int? Coins { get; set; }
        public bool? IsCoinsOverride { get; set; }
        public int? GiftCardMinCoins { get; set; }
        public int? GiftCardMaxCoins { get; set; }
        public bool? IsGiftCardLimitsOverride { get; set; }
        public bool IsIgnoreBusinessSubTypeLimits { get; set; }
        public int? RedimTypeId { get; set; }
        public int? RedimType { get; set; }
        public string VarNameApp { get; set; }
        public int? PaymentModelId { get; set; }
        public bool IsFavorite { get; set; }
        public bool? IsIrgunPriceFormulaOverride { get; set; }
        public int? DefaultRedimType { get; set; }
        public int? LoadingAmount { get; set; }
        public int? IsCatalogPriceOverride { get; set; }
        public int? EventimTicketTypeId { get; set; }
        public string EventimTicketTypeName { get; set; }
        public int? EventimPriceLevelId { get; set; }
        public string EventimPriceLevelName { get; set; }
        public int? TicketsHubEventId { get; set; }
        public int? EventimPriceId { get; set; }
        public string CouponSMS { get; set; }
		public bool? IsSendDigitalCode { get; set; }
	}
}
